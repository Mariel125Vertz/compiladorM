// Generated from /home/mariloks/Escritorio/project/Proyecto/mi_proyecto/lenguaje/Gammar.g4 by ANTLR 4.13.1
...
public class GammarParser extends Parser {
	...
	public static final int
		RULE_pogram = 0, RULE_statement = 1, RULE_assing = 2, RULE_print = 3, 
		RULE_if_statement = 4, RULE_for_statement = 5, RULE_block = 6, RULE_expr = 7;
	private static String[] makeRuleNames() {
		return new String[] {
			"pogram", "statement", "assing", "print", "if_statement", "for_statement", 
			"block", "expr"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "Gammar.g4"; }
	...
	public GammarParser(TokenStream input) {
		super(input);
	...
	public static class PogramContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(GammarParser.EOF, 0); }
		...
		public List<TerminalNode> NEWLINE() { return getTokens(GammarParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(GammarParser.NEWLINE, i);
		}
	...
	public static class AssingContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(GammarParser.ID, 0); }
	...
	public static class For_statementContext extends ParserRuleContext {
		...
		public List<TerminalNode> SEMI() { return getTokens(GammarParser.SEMI); }
		public TerminalNode SEMI(int i) {
			return getToken(GammarParser.SEMI, i);
		}
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
